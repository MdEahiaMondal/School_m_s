                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="activity-desk">
                                                            <h1>Name</h1>
                                                            <h2 class="red">{{ auth()->user()->name }}</h2>
                                                        </div>

                                                        <div class="activity-desk">
                                                            <h1>Email</h1>
                                                            <h2 class="red">{{ auth()->user()->email }}</h2>
                                                        </div>
                                                        <div class="activity-desk">
                                                            <h1>Phone</h1>
                                                            <h2 class="red">{{ auth()->user()->student->phone }}</h2>
                                                        </div>

                                                        <div class="activity-desk">
                                                            <h1>Address</h1>
                                                            <h2 class="red">{{ auth()->user()->student->address }}</h2>
                                                        </div>

                                                        <div class="activity-desk">
                                                            <h1>Role</h1>
                                                            <h2 class="red">
                                                                @foreach(auth()->user()->student->user->roles as $role)
                                                                    {{ $role->name }}
                                                                @endforeach
                                                            </h2>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="activity-desk">
                                                            <h1>Class</h1>
                                                            <h2 class="red">{{ auth()->user()->student->Class->name }}</h2>
                                                        </div>

                                                        <div class="activity-desk">
                                                            <h1>Class Roll</h1>
                                                            <h2 class="red">{{ auth()->user()->student->roll_number }}</h2>
                                                        </div>

                                                        <div class="activity-desk">
                                                            <h1>Age</h1>
                                                            <h2 class="red">{{ auth()->user()->student->age }}</h2>
                                                        </div>
